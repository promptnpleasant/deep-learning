...
class DDPG_Agent():
    ...
    def __init__(self, task):
        ...
        # Actor (Policy) Model
        self.actor_local = DDPG_Actor(self.state_size, self.action_size, self.action_low, self.action_high)
        self.actor_target = DDPG_Actor(self.state_size, self.action_size, self.action_low, self.action_high)

        # Critic (Value) Model
        self.critic_local = DDPG_Critic(self.state_size, self.action_size)
        self.critic_target = DDPG_Critic(self.state_size, self.action_size)
    ...
    def learn(self):
        ...
        #     Q_targets_next = self.critic_target(next_state, actor_target(next_state))
        actions_next = self.actor_target.model.predict_on_batch(next_states)
        #print('learn',next_states, actions_next)
